...
import { ArrowLeft, Sun, Moon, SplitSquareHorizontal, CalendarDays, Calendar, Clock, CheckCircle } from 'lucide-react';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        alert(data.error?.message || 'Failed to create shift');
      }
    } catch (e) {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900">New Shift</h1>
          <p className="text-gray-600 mt-1">Create a new driver shift schedule</p>
        </div>
      </div>
